...
async function loadAndDisplayItems(type = 'bebida', initialCategory = 'todos') {
    categoriaTitulo.textContent = 'Cargando...'; // Muestra un estado de carga
    try {
        // Hacemos una petición GET a la API, filtrando por 'tipo' (ej. 'bebida')
...
document.addEventListener('DOMContentLoaded', () => {
    // Carga los ítems para el tipo 'bebida' cuando la página carga
    loadAndDisplayItems('bebida'); // <-- ¡IMPORTANTE! El tipo aquí es 'bebida'
